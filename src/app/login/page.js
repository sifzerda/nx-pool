        ...
        <div className="relative w-full max-w-md overflow-hidden rounded-[36px] border border-cyan-400/15 bg-black/40 p-10 backdrop-blur-2xl shadow-[0_0_60px_rgba(34,211,238,0.08)]">
          ...
          <form className="flex flex-col gap-6">
            <input
              type="email"
              placeholder="Email"
              className="rounded-xl border border-cyan-400/30 bg-black/60 px-4 py-3 text-white placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/50"
            />
            <input
              type="password"
            ...
            <button
              type="submit"
              className="group relative overflow-hidden rounded-3xl border border-cyan-400/30 bg-cyan-500/10 px-6 py-4 text-sm font-bold text-cyan-100 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300 hover:shadow-[0_0_40px_rgba(34,211,238,0.35)]"
            >
